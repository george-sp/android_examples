...
public class ChangeColor extends Transition {
    ...
    /**
     * Create an animation for each target that is in both the starting and ending Scene.
     * For each pair of targets,
     * if their background property value is a color (rather than a graphic),
     * create a ValueAnimator based on an ArgbEvaluator that interpolates between
     * the starting and ending color.
     * Also create an update listener that sets the View background color
